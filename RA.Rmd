...
library(caTools)
set.seed(222)
sample = sample.split(data_over,SplitRatio = 0.70)
train1 =subset(data_over,sample ==TRUE)
test1=subset(data_over, sample==FALSE)
...
decision <- rpart(Treatment~., data = train1, method = "class", 
